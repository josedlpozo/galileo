package com.josedlpozo.galileo.realm.realmbrowser;
...
import com.josedlpozo.galileo.realm.realmbrowser.files.view.FilesActivity;
...
public final class RealmBrowser {
    ...
    public static void startRealmModelsActivity(@NonNull Context context, @NonNull RealmConfiguration realmConfiguration) {
        DataHolder.getInstance().save(
            DataHolder.DATA_HOLDER_KEY_CONFIG, realmConfiguration);
