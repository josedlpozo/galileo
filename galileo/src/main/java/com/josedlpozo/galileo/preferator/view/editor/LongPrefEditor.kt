...
internal class LongPrefEditor @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0, listener: (Long) -> Unit = {}) : FrameLayout(context, attrs, defStyleAttr) {
